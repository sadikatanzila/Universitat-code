<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="eumo2015.aspx.cs" Inherits="Eastern_Uni.eumo2015" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ContentBody"> 
        ...
        <div id="second">
            ...
            <div id="s_container" style="background-repeat: no-repeat; background-image: url('NewBackup/ContentBanner.jpg')">
                     ...
                     <td style="width:80%; text-align: right; font-weight: bold; font-size: 16px; vertical-align: top;" rowspan="2">
                       ...
                       <asp:LinkButton ID="LinkButtonDownload_Groupdoc" runat="server" Text="/ DOC" Style="color:blue;font-size: 14px;" OnClick="LinkButtonDownload_Groupdoc_Click" onmousemove="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"/>
                        ...
                        <br />
                           ...
                           Last date of registration is Saturday 12th December, 2015                             
                        </span>
</td>
                 </tr>
                 <tr>
...
The aim of the Math Olympiad is to create the opportunity for our young talented students in the country to shine and show their mathematical and analytical talents and to create a national awareness for the development of math skills. We are inviting all the talented students studying in different public and private colleges and interested in math to participate in the Olympiad. Only top 300 students will be allowed to sit for the competition. The Panel of Judges will finalize the list of contestants for the Olympiad. All the concerned students are encouraged to participate in the competition. 
                          <b>Last date of registration is Saturday, 12th December, 2015. </b>
                         <br /><br />
...
<br />
 ...
 <br />&nbsp;&nbsp;&nbsp;&nbsp;5.	Each contestant has to contest individually. 
                          <br />
 <br />&nbsp;&nbsp;&nbsp;&nbsp;6.	All participants must bring their institutional ID card/ letter from the principal of the respective college on the test day. 
                          <br />

 
                 
 <br />&nbsp;&nbsp;&nbsp;&nbsp;7.	Use of laptops , mobile phone and any other electronic devices are prohibited during the Olympiad. <br /> 
                          <br />
&nbsp;&nbsp;&nbsp;&nbsp;8. List of participants will be finalized by the organizing committee.
                          <br /><br />
                           <p style="font-size: 16px; color: #0000FF"  ><b>Registration:</b></p>
&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-family:Symbol;"><span style="">  </span></span> Interested contestants should <b>register on or before Saturday, 12th December, 2015</b>
                          <br />
...
&nbsp;&nbsp;Fax: 		02-9675981 <br />
&nbsp;&nbsp;Mobile:	01716479810, 01558299679 <br />
&nbsp;&nbsp;Email: 	eumo@easternuni.edu.bd; <a href="mailto:fauzia@easternuni.edu.bd">fauzia@easternuni.edu.bd</a>
                          <br />
                          <br />
<b>Selected participants will be informed on Saturday, 12th December, 2015 through email/Phone/SMS. </b> <br />
                                  </td>
                              </tr>
                          </table>
...
<!--
 <img src="image/MathOlympiad/EUMO_poster08122015.jpg" /> 
                         -->
