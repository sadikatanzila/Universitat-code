<%@ Page Title="Photo Gallery" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Photo Gallery.aspx.cs" Inherits="Eastern_Uni.Photo_Gallery" %>
        ...
        <div id="second">
            ...
            <div id="s_container" style="background-repeat: no-repeat; background-image: url('image/Header/PhotoGallery.jpg')">
                ...
                <br />
                  ...
                  <p style="text-align:center;font-size:larger;color:#0000FF; text-decoration: underline overline;">
                       <a href="#"><img src="image/Photo%20Gallery/3rd_Convocation_2013.png" style="height: 750px; width: 790px" /></a>
                    </p>
                ...
                <br />
                  ...
                  <p style="text-align:center;font-size:larger;color:#0000FF; text-decoration: underline overline;">
                       <a href="#"><img src="image/Photo%20Gallery/EU%20Career%20Fair%202013.png" style="height: 750px; width: 790px" /></a>
                    </p>
                ...
                <br />
                  ...
                  <p style="text-align:center;font-size:larger;color:#0000FF; text-decoration: underline overline;">
                       <a href="#"><img src="image/Photo%20Gallery/OrientationFall2013.png" style="height: 750px; width: 790px" /></a>
                    </p>
