...
namespace Eastern_Uni
{
    public partial class Home : System.Web.UI.Page
    {
        ...
        private void contactLink_Click(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                RepeaterItem ri = e.Item;
                Label la = (Label)ri.FindControl("Label5");

                //   Label la = (Label)Repeater1.Items[e.Item.ItemIndex].FindControl("Label5");
                int News_ID = Convert.ToInt32(la.Text);
                //  int age = Convert.ToInt32(Repeater1.DataKeys[e.Item.ItemIndex]);
                Session["AlbumID"] = News_ID;
