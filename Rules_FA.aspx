<%@ Page Title="Financial Aids" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Rules_FA.aspx.cs" Inherits="Eastern_Uni.Rules_FA" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Financial Aids</span>
                ...
                <br />
                    ...
                    <br />
                Student Loan
The University gives soft interest-free study loans to deserving students on affordable terms which will be recovered by easy installments from their salary or income when employed.

                    <br />
                    <br />
                    <strong>Earn -While -You - Learn Program
</strong>
                    <br />
                    The University has a limited provision of awarding Research and Teaching Assistantships to graduate students on merit basis. Financial assistance, in the form of on-campus-job on part-time basis, is also available in a limited number. Further information on Student Loans & Scholarships Support are available from Admission Office of the University. 
                    <br />
                    <br />
                    <br />
                    <strong><span class="auto-style1">Special Facilities</span></strong><br />
                    10% special tuition fee waiver for female students of all programs.
                    <br />
                    25% tuition fee waiver for sibling and husband-wife.
                    <br />
                    25% tuition fee waiver for physically disadvantaged and acid victims.
                    <br />
                    15% tuition fee waiver for tribal students.
                    <br />
                    Interest-free loans for financially disadvantaged.</div>
