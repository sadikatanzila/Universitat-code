<%@ Page Title="Prospective Students" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Prospective Students.aspx.cs" Inherits="Eastern_Uni.Prospective_Students" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container" style="background-image: url('image/Header/Prospective_Students.jpg'); background-repeat: no-repeat;">
                ...
                <table>
                    <tr>
                        ...
                        <td class="auto-style3">
                            <p class="MsoNormal">
                                <span style="font-size:18.0pt; font-weight: bold; text-decoration: underline; color: #0000FF;">Welcome Prospective Student:</span><span style="font-size:10.0pt"><o:p></o:p></span></p>
                            <p class="MsoNormal">
                                <span style="font-size:10.0pt"><o:p>&nbsp;</o:p></span></p>
                            <p class="MsoNormal">
                                <span style="font-size:12.0pt">Welcome prospective student. We are happy to know that you are considering <st1:place w:st="on"><st1:placename
 w:st="on">Eastern</st1:PlaceName> <st1:placetype w:st="on">University</st1:PlaceType></st1:place>
                                as a possible destination for your undergraduate/graduate education. Here we have provided links to some basic information that may interest you or guide you in making the correct decision. <o:p></o:p>
                                </span>
                            </p>
                            </td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style3">
                             ...
                             <p class="MsoNormal">
                                 <span style="font-family:Symbol;"><span style="">• </span></span><a href="Admission_WEU.aspx" style="text-decoration: underline; color: #0000FF;">Why EU?</a>
                            
                                      </p>

                                <p class="MsoNormal">
                                 <span style="font-family:Symbol; "><span style="">• </span></span> <a href="Academics_UP.aspx" style="text-decoration: underline; color: #0000FF;">Undergraduate Program</a><br class="auto-style1" />
                             </p> 
                            <p class="MsoNormal">
                                 <span style="font-family:Symbol;"><span style="">• </span></span> <a href="Academics_GP.aspx" style="text-decoration: underline; color: #0000FF;">Graduate Program</a><br class="auto-style1" />
                             </p> <br />
                            ...
                            <p class="MsoNormal">
                                 <span style="font-family:Symbol;"><span style="">• </span></span> <a href="Admission_Overview.aspx" style="text-decoration: underline; color: #0000FF;">Admission Overview</a><br class="auto-style1" />
                             </p> 
                            <p class="MsoNormal">
                                 <span style="font-family:Symbol; "><span style="">• </span></span> <a href="Admission_UA.aspx" style="text-decoration: underline; color: #0000FF;">Undergraduate Admission</a><br class="auto-style1" />
                             </p> 
                            <p class="MsoNormal">
                                 <span style="font-family:Symbol; "><span style="">• </span></span>  <a href="Admission_GA.aspx" style="text-decoration: underline; color: #0000FF;">Graduate Admission</a><br class="auto-style1" />
                             </p>  



                             <p class="MsoNormal">
                                 <span style="font-family:Symbol; "><span style="">• </span></span> <a href="Admission_TF.aspx" style="text-decoration: underline; color: #0000FF;">Tution and Fees</a><br class="auto-style1" />
                             </p> 
                            <p class="MsoNormal">
                                 <span style="font-family:Symbol;"><span style="">• </span></span>  <a href="Admission_FAidSch.aspx" style="text-decoration: underline; color: #0000FF;">Financial Aid & Scholarship</a><br class="auto-style1" />
                             </p>  
                   ...
                   <br />
                            ...
                            <p class="MsoNormal">
                                 <span style="font-family:Symbol;"><span style="">• </span></span> <a href="Life_Campus_SC.aspx" style="text-decoration: underline; color: #0000FF;">Co-curricular Activities</a><br class="auto-style1" />
                             </p> 
                          <!--  <p class="MsoNormal">
                                 <span style="font-family:Symbol; 
Symbol"><span style="">·</span></span>  <a href="Phy_Coucilling.aspx" style="text-decoration: underline; color: #0000FF;">Phychological Counselling</a><br class="auto-style1" />
                             </p>  -->
                             <p class="MsoNormal">
                                 <span style="font-family:Symbol; "><span style="">• </span></span>  <a href="Campus Map.aspx" style="text-decoration: underline; color: #0000FF;">Campus Map</a><br class="auto-style1" />
                             </p> 
