<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="HR_Careerdtl.aspx.cs" Inherits="Eastern_Uni.HR_Careerdtl" %>
...
<!--
   ...
   <tr>
       <td>
             <asp:Label ID="lblPost" runat="server" Font-Bold="True" Font-Size="Large"></asp:Label>
           <br />
            <asp:Label ID="lblEU" runat="server" Text="Eastern University" Font-Size="Medium"></asp:Label>
           <br /><br />


            <asp:Label ID="Label5" runat="server" Text="No. of  Vacancies" Font-Size="Medium" Font-Bold="True"></asp:Label>
           <br />
            <asp:Label ID="lblValue" runat="server" Text=""></asp:Label>
           <br /><br />


            <asp:Label ID="Label2" runat="server" Text="Job Description / Responsibility" Font-Size="Medium" Font-Bold="True"></asp:Label>
           <br />
            <asp:Label ID="lblResponsibility" runat="server" Text=""></asp:Label>
           <br /><br />
            <asp:Label ID="Label4" runat="server" Text="Job Nature" Font-Size="Medium" Font-Bold="True"></asp:Label>
           <br />
           ...
           <br /><br />
            <asp:Label ID="Label3" runat="server" Text="Educational Requrements" Font-Size="Medium" Font-Bold="True"></asp:Label>
           <br />
            <asp:Label ID="lblEducational_Req" runat="server" Text=""></asp:Label>
           <br /><br />
            <asp:Label ID="Label6" runat="server" Text="Experience" Font-Size="Medium" Font-Bold="True"></asp:Label>
           <br />
            <asp:Label ID="lblJobTime_Experience" runat="server" Text=""></asp:Label>
            <br />
            <asp:Label ID="lblWorking_Experience" runat="server" Text=""></asp:Label>


           <br /><br />
            <asp:Label ID="Label1" runat="server" Text="Additional Job Requirements" Font-Size="Medium" Font-Bold="True"></asp:Label>
           <br />
            <asp:Label ID="lblAdditional_Req" runat="server" Text=""></asp:Label>
           <br /><br />
            <asp:Label ID="Label7" runat="server" Text="Job_Location" Font-Size="Medium" Font-Bold="True"></asp:Label>
           <br />
            <asp:Label ID="lblJob_Location" runat="server" Text=""></asp:Label>

           <br /><br />
            <asp:Label ID="Label9" runat="server" Text="Salary Range" Font-Size="Medium" Font-Bold="True"></asp:Label>
           <br />
            <asp:Label ID="lblSalary_Range" runat="server" Text=""></asp:Label>
           <br /><br />
            <asp:Label ID="Label11" runat="server" Text="Deadline" Font-Size="Medium" Font-Bold="True"></asp:Label>
           <br />
   ...
   <tr style="text-align: center">
       <td>
             <asp:Button ID="btnApply" runat="server" Text="Apply for the Post" OnClick="btnApply_Click" />
       </td>
   </tr>
  </table>
