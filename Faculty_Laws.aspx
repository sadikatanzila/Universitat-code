<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Faculty_Laws.aspx.cs" Inherits="Eastern_Uni.Faculty_Laws" %>
                ...
                <form id="Form1" runat="server">
                    ...
                    <asp:GridView ID="gvDepartment" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                ...
                                                <Columns>
                                                        ...
                                                        <asp:TemplateField  HeaderText="Faculty of Law"  ItemStyle-Width="65%">
                                                        <ItemTemplate>
