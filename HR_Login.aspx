<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HR_Login.aspx.cs" Inherits="Eastern_Uni.HR_Login" %>
...
<div style=" width: 307px; margin-left: 150px;">
                      ...
                      <tr>
                          <td>
                               <asp:TextBox ID="txtHR_Username" runat="server" Width="200" value="" onfocus="if(this.value=='user name .........')this.value=''" onblur="if(this.value=='')this.value='user name .........'" style="margin-left: 43px"></asp:TextBox>
                      ...
                      <tr style="background-color: #4276E3">
                         <td align="middle" valign="top">
                                <a  href="../HomeEU.aspx" style="color: #FFFFFF; font-weight: bold;">Home</a></td>
                      </tr>
