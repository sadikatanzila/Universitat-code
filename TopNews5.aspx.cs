...
{
    public partial class TopNews5 : System.Web.UI.Page
    {
        ...
        protected void setevents()
        {
            ...
            SqlCommand cmd = new SqlCommand("select top 1  headline,detail from (select top 5 * from TopNews order by serial_no desc) as sub order by serial_no asc", conn);
