<%@ Page Title="Faculty of BBA" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="List_BBA.aspx.cs" Inherits="Eastern_Uni.List_BBA" %>
      ...
      <div id="first">
        ...
        <div id="second">
            ...
            <div id="s_container">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Faculty of Business Administration </span>
                ...
                <form runat="server">
                    ...
                    <asp:DataList ID="datalist_b" runat="server">
