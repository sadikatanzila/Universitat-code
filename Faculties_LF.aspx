<%@ Page Title="List of Faculties" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Faculties_LF.aspx.cs" Inherits="Eastern_Uni.Faculties_LF" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; List of Faculties</span>
                
                <br />
                <br />
                <br />

                <a href="F_BBA.aspx"><span style="font-size:larger;text-decoration:underline;text-shadow:#6eabed">  
                    Faculty of Business Administration

                           </span></a>
                <br />

                <a href="F_Engg.aspx"><span style="font-size:larger;text-decoration:underline;text-shadow:#6eabed">  
                    Faculty of Engineering & Technology
                           </span></a>
                <br />

                <a href="F_Arts.aspx"><span style="font-size:larger;text-decoration:underline;text-shadow:#6eabed">  
                    Faculty of Arts
                           </span></a>
                <br />

                <a href="F_Laws.aspx"><span style="font-size:larger;text-decoration:underline;text-shadow:#6eabed">  
                    Faculty of Laws
                           </span></a>
