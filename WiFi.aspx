<%@ Page Title="Internal WiFi" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="WiFi.aspx.cs" Inherits="Eastern_Uni.WiFi" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container" style="background-repeat: no-repeat; background-image: url('image/About EU/Board_of_Trustees_photo.png')">
