<%@ Page Title="Examination Rules" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Rules_ER.aspx.cs" Inherits="Eastern_Uni.Rules_ER" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Examination Rules</span>
                
                <br />
                <br />
                    <br />
                
                    <strong>Tests and Exams
                    </strong>
                    <br />
                    Quizzes /Tests/ Class Assignments are scheduled in class hour or tutorial hour. The duration of a quiz may be between 5 to 15 minutes and that of a class test between 15 to 30 minutes Mid-term exam is held in the. week announced in the Semester Calendar. The duration of the Mid-term exam is between one to two hours . Final exam schedule is announced by the University. The duration of the final exam is between 2 to 3 hours.
                    <br />
                    <br />
                    <strong>Unfair Means
                    </strong>
...
• copying from another student's script or report or paper;
                    <br />
                    <br />
                    • copying from printed matter, hand-written script, writing on desk or palm of hand, or from 
...
<br />
                    ...
                    <br />
                    <br />
                    <strong>Course Retake
</strong>
                    <br />
                    A student earning "F" grade in a course is required to earn at least the passing grade by retaking the course in the next semester on payment of requisite fees. A student may also choose to improve the grade by retaking the course on payment of course fees. In case of a course retake , the transcript of a student shall show the grade which is higher <br />
