<%@ Page Title="" Language="C#" MasterPageFile="~/HR_AdminHome.Master" AutoEventWireup="true" CodeBehind="HR_MenuHeader.aspx.cs" Inherits="Eastern_Uni.HR_MenuHeader" %>
                ...
                <table style="padding-left: 50px; width: 463px;">
                    <tr>
                        <td class="auto-style1" style="text-align: left">
                            <asp:Label ID="lblPageName" runat="server" Text="Header Name"></asp:Label>
                        </td>
                        <td>: </td>
