<%@ Page Title="Faculty of Engineering" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="List_Engr.aspx.cs" Inherits="Eastern_Uni.List_Engr" %>
      ...
      <div id="first">
          <div id='cssmenu'>
                <ul>
                     ...
                     <li class="has-sub"><a href="#"><span>Admission</span></a>
                        <ul>
                           <li><a href="Admission_Overview.aspx"><span>Overview</span></a></li><li><a href="http://old.easternuni.edu.bd:8080/onlineadmission/index.aspx"><span>Online Admission Form</span></a></li>
                            ...
                            <li class="last"><a href="Admission_P.aspx"><span>Prospectus</span></a></li>
                        </ul>
                    </li>
                   ...
                   <li class="has-sub"><a href="#"><span>Faculty</span></a>
                    ...
                    <li class="has-sub"><a href="#"><span>Total Faculty Search</span></a>
                        <ul>
                           <!-- <li><a href="ListByFaculty.aspx"><span>List By Faculties</span></a></li>-->
                            <li><a href="ListByName.aspx"><span>List By Name</span></a></li>
                  ...
                  <li><a href="http://gsdl.easternuni.edu.bd/greenstone/collect/3eunewsletter/index/assoc/HASH0e35.dir/doc.pdf "><span>Newsletter</span></a></li>
                    ...
                    <li class="has-sub"><a href="#"><span>Life on Campus</span></a>
                        <ul>
        ...
        <div id="second">
            ...
            <div id="s_container">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Faculty of Engineering & Technology </span>
