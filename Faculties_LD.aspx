<%@ Page Title="List of Department" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Faculties_LD.aspx.cs" Inherits="Eastern_Uni.Faculties_LD" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; List of Departments</span>
                ...
                <ul>
                    <li>Faculty of Business Administration
                    ...
                    <br />
                    <li>Faculty of Engineering and Technology

                        <ul>
                            <li>Computer Science and Engineering</li>
                            <li>Electrical and Electronic Engineering</li>
                            <li>Electrical and Telecommunication Engineering</li>
                        </ul>
                    </li>
                    <br />
                    ...
                    <li>Faculty of Arts
                        ...
                        <li>M.A. ELL (English Language and Literature)</li>
                        <li> M.A. ELT (English Language Teaching)</li></ul>
