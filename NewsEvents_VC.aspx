<%@ Page Title="News Events VC" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="NewsEvents_VC.aspx.cs" Inherits="Eastern_Uni.NewsEvents_VC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ContentBody"> 
        ...
        <div id="second">
            ...
            <div id="s_container" style="background-repeat: no-repeat; background-image: url('NewBackup/NewsVC.jpg')">
                ...
                <table style="width:95%; margin-left:25px">
                    <tr>
                        <td>
                             <asp:Label ID="errorMsg" runat="server" Text="" ForeColor="Red" Font-Bold="True"></asp:Label>
                                <asp:Button ID="btnView" runat="server" Text="Search News & Events" OnClick="btnView_Click" BackColor="#9BFFBC" Font-Bold="True" Width="241px"  Visible="false" />
                    ...
                    <tr>
                     ...
                     CellPadding="3"  DataKeyNames="serial_no" EmptyDataText="News events are not available" ShowHeaderWhenEmpty="True"
                                               Width="98%" style="margin-left: 5px" 
                    ...
                    <ItemTemplate>
                          <asp:Label ID="lblHeading" runat="server" Text='<%#Bind("headline") %>' ForeColor="#000099" Font-Size="20px" ></asp:Label><br />
                        <asp:Label ID="lblDay" runat="server" Text='<%#Bind("date") %>' ForeColor="#202020" Visible="false"></asp:Label>
                            &nbsp&nbsp&nbsp<asp:Label ID="lblMonth" runat="server" Text='<%#Bind("month") %>' ForeColor="#202020"  Visible="false"></asp:Label>
                            &nbsp&nbsp&nbsp<asp:Label ID="lblYear" runat="server" Text='<%#Bind("year") %>' ForeColor="#202020"  Visible="false"></asp:Label>
                           


                         <asp:Image ID="PicLoc" runat="server"  ImageUrl='<%# Bind("PictureLocation") %>' Width="900px"  AlternateText=" "/>   
                                
                        
                        <br />    <asp:Label ID="lbldetails" runat="server"  Text='<%#Bind("details") %>' Font-Size="14px"  ForeColor="#202020"></asp:Label>  
                        <br />           
                    </ItemTemplate>
