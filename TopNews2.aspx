<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="TopNews2.aspx.cs" Inherits="Eastern_Uni.TopNews2" %>
              ...
              <table>
                  <tr>
                      ...
                      <td class="auto-style2">
                          <br /> <br /> 
                           <asp:Image ID="Image1" runat="server" ImageUrl="~/Admins/Data/EUMO.jpg" Height="90px" Width="100px"/>
                      ...
                      <td class="auto-style2">
                          <p  style="text-align:center;font-size:25px;color:blue; font-weight: bold; font-style: normal; margin-left: 28px; width: 608px;">
...
<a href="StudentRegistration.aspx" style="color:blue; font-weight: bold;"><span>Click here for Online Registration</span></a>
                  ...
                  <tr>
                      <td class="auto-style1">
                          ...
                          &nbsp;</td>
                      <td class="auto-style2" colspan="2" style="text-align:right;font-weight: bold;">
                          
                           Download Application form :
                            <br />
                            <a href="image/MathOlympiad/GROUP REGISTRATION FORM.pdf" style="color: #0000FF; font-weight: bold; " onmousemove="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">Faculty Position</a>
                                 &nbsp; ||  &nbsp;
                            <a href="image/MathOlympiad/INDIVIDUAL REGISTRATION FORM.pdf" style="color: #0000FF; font-weight: bold;" onmousemove="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">Administrative Position</a>
              ...
              <p  style="text-align:center;color:blue; font-weight: bold; font-style: normal; margin-left: 28px;"> <b>-: Call for Participation :-</b>    
                  </p>

                          <br />
                          It is our great pleasure to inform you that the Faculty of Engineering and Technology (E&T), Eastern University, Dhaka is going to organize the 3rd  Eastern University Math Olympiad, EUMO 2014 on the 26th September, 2014 (Friday) to be held in Eastern University premises, House No. 26, Road No. 5, Dhanmondi R/A, Dhaka 1205. A good number of scientists, technologists and researchers from different arena will be attending the event. 
<br /><br />
The aim of the Math Olympiad is to create the opportunity for our young talented students in the country to shine and show their mathematical and analytical talents and to create a national awareness for the development of math skills. We are inviting all the talented mathematicians studying in different public and private colleges to participate in the Olympiad. Only top 300 students will be allowed to sit for the competition. The Panel of Judges will finalize the list of contestants for the Olympiad. All the concerned students are encouraged to participate in the competition. Last date of registration is 11th September, 2014 (Sunday). 
 <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-family:Symbol;"><span style=""> 	</span></span>&nbsp;&nbsp; 	Champion Gets BDT Ten Thousand
 <br />&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-family:Symbol;"><span style=""> 	</span></span>&nbsp;&nbsp; 	BDT Seven Thousand Five Hundred For 1st Runner Up
 <br />&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-family:Symbol;"><span style=""> 	</span></span>&nbsp;&nbsp; 	BDT Five Thousand For 2nd Runner Up
 <br />&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-family:Symbol;"><span style=""> 	</span></span>&nbsp;&nbsp; 	Seven Honorary Mentions [BDT One Thousand Each]
