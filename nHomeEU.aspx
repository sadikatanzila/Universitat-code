<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nHomeEU.aspx.cs" Inherits="Eastern_Uni.nHomeEU" %>
				  ...
				  <div class="item">
				  	<div class="row dateAndTitle">
				  		...
				  		<div class="col-9" style="word-wrap: break-word">
				  			<p>Here is the title Lorem ipsum dolor sit amet <a href="#">Read More</a></p>
				  		</div>
				  	</div>

				  	<div class="eventsNews">
				  		<figure class="figure">
  							<img src="img/news and events/1.jpg" class="figure-img img-fluid rounded eventImage" alt="A generic square placeholder image with rounded corners in a figure.">
  							<figcaption class="figure-caption">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
  							tempor incididunt ut labore et dolore <a href="#">Read More</a></figcaption>
						</figure>
				  	</div>
				  </div>
				  	...
				  	<div class="eventsNews">
				  		<figure class="figure">
  							<img src="img/news and events/2.jpg" class="figure-img img-fluid rounded eventImage" alt="A generic square placeholder image with rounded corners in a figure.">
  							<figcaption class="figure-caption">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
  							tempor incididunt ut labore et dolore <a href="#">Read More</a></figcaption>
						</figure>
				  	</div>
...
<div class='life pt-3'>
    <div class="row">
        <div class="col-md-8 col-sm-12 col-xm-12">
            ...
            <p>Appellat a culpa commodo eu si magna eu anim. Malis quo mandaremus ne ita sunt 
