<%@ Page Title="Scholarship" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Rules_S.aspx.cs" Inherits="Eastern_Uni.Rules_S" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Student Scholarships</span>
                ...
                Aiming at imparting excellent education, Eastern University envisages that a combination of quality students and quality teaching is a prerequisite for quality education. So, it offers a significant number of fee waivers and scholarships to attract and support meritorious students.
                ...
                <ul>
                   <li> Chancellor&#39;s Gold Medal </li>
                       <br />
                  <li>  Chairman&#39;s Gold Medal</li>
                    <br />
                  <li>  Vice Chancellor&#39;s Gold</li>
                    <br />
                   <li> Medal Abul Quasem</li>
                    <br />
                  <li>  Haider Education Development Scholarship</li>
                    <br />
                  <li>  Anwara Begum Scholarship</li>
                    <br />
                  <li>  Khalil-Anwara Scholarship</li>
                    <br />
                   <li> Khurshida Begum Scholarship</li>
                    <br />
                   <li> Jhahima Khatun Scholarship</li>
                    <br />
                   <li> Zinnater Noor Scholarship</li>
                    <br />
                  <li>  Mohammad Enayet Ullah Scholarship</li>
                    <br />
                  <li>  Farida Akhtar Scholarship </li>
