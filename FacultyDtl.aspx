<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="FacultyDtl.aspx.cs" Inherits="Eastern_Uni.FacultyDtl" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container" style="background-position: inherit center; background-image: url('image/Other/ContentBanner.png'); background-repeat: no-repeat;">
                    ...
                    <asp:GridView ID="gvFacultyDtl" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                ...
                                                <Columns>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <br /><br />
                                                            <asp:Label ID="lbName" runat="server" Text='<%#Bind("Name") %>' style="font-size:medium;text-transform:uppercase;font-weight: bold;" Font-Underline="True"></asp:Label>
                                                            <br /><br />
                                                            <asp:Label ID="lblDesignation" runat="server" Text='<%#Bind("Designation") %>'></asp:Label>
                                                            <br />
                                                            <asp:Label ID="lblEmail" runat="server" Text='<%#Bind("Email") %>'></asp:Label>
                                                            <br />
                                                           <asp:Label ID="lblMobileNo" runat="server" Text='<%#Bind("Phone") %>'></asp:Label>
                                                            <br />
