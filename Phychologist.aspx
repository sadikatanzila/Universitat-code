<%@ Page Title="Phychologist" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Phychologist.aspx.cs" Inherits="Eastern_Uni.Phychologist" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EU Phychologist</span>
                ...
                <br />
                    ...
                    <br />
                    <br />
                    Education is a cognitive process where sound mental health is one of the prime conditions. So stable and sound mental health is very important for Education. To maintain and develop proper Mental Health Counselling ( Psycho social) is a mandatory tool for students.<br />
                    <br />
                    Counselling is an interactive process characterized by a unique relationship between counsellor and client that leads to change in the client&#39;s behavior, beliefs, coping ability, decision-making knowledge and skills and level of emotional distress.
                    <br />
                    <br />
                    Counselling service considers the dignity and worth of all individuals of the university and embraces human diversity within a warm, accepting, and confidential environment.
                    <br />
                    <br />
                    <strong>Area of Counselling Service: </strong>
                    <br />
                <br />
                ...
                <li> Anger Management </li>
                 ...
                 <li>   Reduce Anxiety</li>
                  ...
                  <li>  Communication Problems</li>
                    <br />
                   <li> or Lack of Social Skills</li>
                    <br />
                   <li> Developing Self Esteem</li>
                    <br />
                   <li> Bereavement, etc</li>
                    <br /></ul>
                    <br />
                 <strong>Confidentiality: </strong>
                    ...
                    <br />
                    Confidentiality is a very important requirement for Psycho social counselling. It is taken very seriously by professional counsellors and psychotherapists and everything that is discussed in a counselling session is kept in the strictest confidence. </div>
