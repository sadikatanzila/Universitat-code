<%@ Page Title="" Language="C#" MasterPageFile="~/HR_AdminHome.Master" AutoEventWireup="true" CodeBehind="HR_JobPositionType.aspx.cs" Inherits="Eastern_Uni.HR_JobPositionType" %>
     ...
     <div>
                ...
                <table style="padding-left: 50px; width:80%">
                    <tr>
                        <td style="text-align: left" class="auto-style1">
                            <asp:Label ID="lbltype" runat="server" Text="Category"></asp:Label>
                        </td>
                        <td>
                            :</td>
                        <td style="text-align: left">
                             <asp:TextBox ID="txtCategory" runat="server" Width="250px"></asp:TextBox>
                             <asp:Label ID="lblmsg" runat="server"  Text="Administrative/ Academic" ForeColor="#666666"></asp:Label>
                        </td>
                    </tr>
                    <tr>
            ...
            <div align="center" style="width: 100%;">
                <asp:Panel ID="panelGV" runat="server" ScrollBars="Auto" Width="60%" Height="320px">
                    ...
                    <asp:GridView ID="gvJobCategory" runat="server" AutoGenerateColumns="false" BackColor="White"
                        BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="JobCat_Id"
                        ...
                        Width="100%" OnPageIndexChanging="gvJobCategory_PageIndexChanging" OnRowDeleting="gvJobCategory_RowDeleting" OnRowEditing="gvJobCategory_RowEditing"  >
