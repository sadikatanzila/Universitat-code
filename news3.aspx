<%@ Page Title="EU News" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="news3.aspx.cs" Inherits="Eastern_Uni.news3" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container" style="background-repeat: no-repeat; background-image: url('image/Other/MasterBG_HomePage.png')">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Eastern University News</span>
                
                <br />
                <br />
                <br />

                  <p style="text-align:center;font-size:larger;color:#c34500;">
