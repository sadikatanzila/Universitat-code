<%@ Page Title="" Language="C#" MasterPageFile="~/HR_AdminHome.Master" AutoEventWireup="true" CodeBehind="HR_AppliedSection.aspx.cs" Inherits="Eastern_Uni.HR_AppliedSection" %>
     ...
     <div>
                ...
                <table style="padding-left: 50px; width:80%">
                    ...
                    <tr>
                        <td class="auto-style1" style="text-align: left">
                            <asp:Label ID="lblPosition" runat="server" Text="Section/ Department"></asp:Label>
                        </td>
                        <td>:</td>
                        <td style="text-align: left">
            ...
            <div align="center" style="width: 100%;">
                <asp:Panel ID="panelGV" runat="server" ScrollBars="Auto" Width="60%" Height="320px">
                    ...
                    <asp:GridView ID="gvAppliedDept" runat="server" AutoGenerateColumns="false" BackColor="White"
                        BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="DepartmentID"
                        EmptyDataText="No Data Found" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-Font-Bold="true"
                        EmptyDataRowStyle-HorizontalAlign="Center" OnRowDataBound="gvAppliedDept_RowDataBound" 
                        Width="100%" OnPageIndexChanging="gvAppliedDept_PageIndexChanging" OnRowDeleting="gvAppliedDept_RowDeleting" OnRowEditing="gvAppliedDept_RowEditing"  >
                        ...
                        <HeaderStyle HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField  HeaderText="Job Category" ItemStyle-Width="30%">
