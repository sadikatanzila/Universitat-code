<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="HomeEU.aspx.cs" Inherits="Eastern_Uni.HomeEU" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <meta name ="title" content="EU Home" />
     <meta name ="author" content="EU Home" />
    <meta name="keywords" content="Top Ten University in Bangladesh, Engineering University in Bangladesh" />
...
<img src="img/Convocation_25June2019.jpg" alt="" title="#caption4"  /> 
 
            <img src="img/ConvoSlider.jpg" alt="" />
 

       <img src="img/WebBanner_Fall_2019_22July2019.jpg" alt=""  title="#caption4"/> 

          

          <!--  <img src="img/CLIMATE.jpg" alt=""  />-->

            <img src="img/Mourt2019.jpg" alt="" />

            <img src="img/EUMO_2018.jpg" alt="" title="#caption2"/>

            <img src="img/UGC_2019.jpg" alt="" title="#caption3"/> 

         <!--   <img src="img/ClubCurnival2017.jpg" alt=""  title="#caption5"/>   -->  
            ...
            <img src="img/EUPC.jpg" alt="" />

            <img src="img/HSC2017.jpg" alt="" />

           <!--  <img src="img/student2017.jpg" alt="" />
           
 
            <img src="img/InterFaculty2017.jpg" alt="" />-->
 
           

        
                
            <img src="img/CulturalProg.jpg" alt="" />



        <!--  <img src="img/Culture_26052018.jpg" alt="" />
             <img src="img/FallFiesta.jpg" alt=""  title="#caption6"/>

            <img src="img/EUMO_2018_2.jpg" alt="" title="#caption2"/>
                <img src="img/CSEFest.jpg" alt="" />
        ...
        <img src="img/EUMO2016.jpg" alt="" />
            <img src="img/AdFair_09012018.jpg" alt="" title="#caption4" />
        <img src="img/Spring2018_new.jpg" alt=""  title="#caption3"/>
...
<div id="caption1" class="nivo-html-caption" >
    ...
    <div id="caption2" class="nivo-html-caption" >
			<strong>5th Eastern University Math Olympiad</strong> 
		</div>

 <div id="caption3" class="nivo-html-caption" >
			<strong>EU congratulated newly Appointed UGC Chairman</strong> 

<div id="caption4" class="nivo-html-caption" >
			<strong>Convocation Registration is going on</strong> 
		</div>


<div id="caption5" class="nivo-html-caption" >
			<strong>Club Carnival 2017 at Eastern University</strong> 
		</div>

<div id="caption6" class="nivo-html-caption" >
			<strong>Fall Fiesta 2018</strong> 
		</div>
                     ...
                     CellPadding="3"  DataKeyNames="id" EmptyDataText="" ShowHeaderWhenEmpty="True"
                      ...
                      <asp:TemplateField ItemStyle-Width="100%" >
                        ...
                        <ItemTemplate >
                         ...
                         <br />    <asp:Label ID="lblbrief" runat="server"  Text='<%#Bind("brief") %>' Font-Size="12px"  ForeColor="#202020"></asp:Label>
                              <br /><asp:Label ID="lblpubdate" runat="server"  Text="Publish Date :" Font-Size="10px"  ForeColor="#202020"></asp:Label>
              ...
              <a href="http://www.tamk.fi/web/tamken/home"> <img src="image/Partner_Uni/TA.jpg" style="height: 50px; width: 60px; margin: 2px; border: solid medium rgba(105, 99, 185, 0.71)" /></a>
               ...
               <a href="http://www.brockport.edu/"> <img src="image/Partner_Uni/brockport.jpg" style="height: 50px; width: 45px; margin: 2px; border: solid medium rgba(105, 99, 185, 0.71)" /></a>
                 <a href="http://gjjl.ynvtc.cn/gjjlc_en/"> <img src="image/Partner_Uni/ynvtc.jpg" style="height: 50px; width: 45px; margin: 2px; border: solid medium rgba(105, 99, 185, 0.71)" /></a>
                        <a href="http://www.csc.edu.cn/studyinchina/indexen.aspx"> <img src="image/Partner_Uni/HZNU_logo.jpg" style="height: 50px; width: 50px; margin: 2px; border: solid medium rgba(105, 99, 185, 0.71)" /></a>
