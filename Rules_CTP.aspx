<%@ Page Title="Credit Transfer Policies" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Rules_CTP.aspx.cs" Inherits="Eastern_Uni.Rules_CTR" %>
...
<!--
        ...
        <div id="second">
            ...
            <div id="s_container">
                ...
                <span id="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Credit Transfer Policies</span>
                ...
                Transfer students are expected to have at least a 2.50 CGPA on a 4-point scale in all University level programs to be considered for admission to Eastern University. Catalogs and official transcripts from previously attended Universities must be furnished with the application for admission. Transcripts must be sent directly to the EU Registrar's Office from each institution attended.
                    <br />
                    <br />
                    An undergraduate student may transfer (through grade transfer or exemption or a combination of both) a maximum of 35 percent of the total credit hours required for the degree in question at EU. In exceptional cases, the Equivalence Committee may, on recommendation of concerned Dean, consider extending the credits up to 40 percent.
                    <br />
                    <br />
                    Courses with B grades as per Eastern University standard may be considered for transfer or exemption. In some cases, courses with C+ grades may also be considered. For the purpose of transferring credits, the Equivalence Committee of the University determines equivalence of courses and grades for each transfer student. The curriculum, evaluation system and grading standard of the university from which the student is transferring must be comparable to those of which reserves the right to make final decision on transfer.
            </div>
